...
// Mismo glifo que el demo tinywasm/layout/platformd/modules/devices que este
// módulo lleva a producción — una silueta de laptop, para que el icono se
// lea igual en ambos lugares.
func (m *Icons) IconSvg() *sprite.Sprite {
	return sprite.NewSprite(
		sprite.Define(svg.Icon("device_manager"), "0 0 448 512",
